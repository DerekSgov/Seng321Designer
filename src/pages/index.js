        ...
        <div id="main">
          ...
          <section id="RSD" className="main special">
            ...
            <footer className="major">
              <ul className="actions">
                <li>
                    <a href='/static/assets/RSD2.pdf' className="button special">
                      View RSD 1.0
                    </a>
                </li>
              </ul>
            ...
            <footer className="major">
              <ul className="actions">
                <li>
                    <a href='/static/assets/RSD3.pdf' className="button special">
                      View RSD 3.0
                    </a>
                </li>
              </ul>
              ...
              <ul className="actions">
                <li>
                    <a href='/static/assets/RSDFinal.pdf' className="button special">
                      View RSD Final
                    </a>
                </li>
              </ul>
